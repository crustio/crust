...
use frame_support::{
    ...
    dispatch::DispatchResult, ensure, PalletId,
...
use primitives::{
    ...
    traits::{
        MarketInterface, SworkerInterface
    }
};
