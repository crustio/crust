...
decl_module! {
    pub struct Module<T: Config> for enum Call where origin: T::Origin {
        ...
        // upgrade for 0.11.1 and spec 14
...
impl<T: Config> Module<T> {
    ...
    /// Remove all staking, treasury and democracy
    fn do_upgrade() {
        ...
        remove_storage_prefix(b"Treasury", b"Tips", &[]);
        remove_storage_prefix(b"Treasury", b"Reasons", &[]);
