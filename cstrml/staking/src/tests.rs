...
#[test]
fn migration_cru18_bonding_lock_should_work() {
    ExtBuilder::default()
        .build()
        .execute_with(|| {
            for i in 130..300 {
                let _ = Balances::make_free_balance_be(&i, 5000);
            }
            // 131: bond 4000, cru18 5000
            assert_ok!(Staking::bond(
                Origin::signed(131),
                132,
                4000
            ...
            // 133: bond 3000, cru18 5000, used 1000 => free 4000
            assert_ok!(Staking::bond(
                Origin::signed(133),
                134,
                3000
            ...
            let _ = Balances::make_free_balance_be(&133, 4000);

            // 133: bond 3000, cru18 5000, added 1000 => free 6000
            assert_ok!(Staking::bond(
                Origin::signed(135),
                136,
                3000
            ...
            let _ = Balances::make_free_balance_be(&135, 6000);

            // Test migration
            Staking::bonding_all_cru18();
