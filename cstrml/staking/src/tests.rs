...
fn multi_era_reward_should_work() {
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            let total_payout_0 = current_total_payout_for_duration(3000 * 100);
            ...
            let total_payout_1 = current_total_payout_for_duration(3000 * 100);
        ...
        .execute_with(|| {
            ...
            assert_noop!(
                ...
                DispatchError::Module {
                    index: 0,
                    error: 4,
                    message: Some("EmptyTargets"),
                }
            );

            let total_payout = current_total_payout_for_duration(3000 * 100);
...
fn double_staking_should_fail() {
    ...
    ExtBuilder::default().build().execute_with(|| {
        ...
        assert_noop!(
            Staking::guarantee(Origin::signed(1), vec![(1, arbitrary_value),]),
            Error::<Test>::NotController
        );
...
fn reward_destination_works() {
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            // Compute total payout now for whole duration as other parameter won't change
            let total_payout_0 = current_total_payout_for_duration(300 * 1000);
            assert!(total_payout_0 > 100); // Test is meaningfull if reward something
            <Module<Test>>::reward_by_ids(vec![(11, 1)]);
...
fn slot_stake_is_least_staked_validator_and_exposure_defines_maximum_punishment() {
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            assert_eq!(Staking::slot_stake(), 4000);
...
/*fn phragmen_linear_worse_case_equalize() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            bond_guarantor(2, 2000, vec![11]);
            bond_guarantor(4, 1000, vec![11, 21]);
            bond_guarantor(6, 1000, vec![21, 31]);
            bond_guarantor(8, 1000, vec![31, 41]);
            bond_guarantor(110, 1000, vec![41, 51]);
            bond_guarantor(120, 1000, vec![51, 61]);
            bond_guarantor(130, 1000, vec![61, 71]);
...
fn update_stakers_should_work_new_era() {
    ...
    .execute_with(|| {
        ...
        assert_ok!(Staking::guarantee(Origin::signed(2), vec![
            (5, 500),
        ]));
        assert_ok!(Staking::guarantee(Origin::signed(6), vec![
            (5, 500),
        ]));
        assert_ok!(Staking::guarantee(Origin::signed(8), vec![
            (5, 500),
        ]));
...
fn guarantee_limit_should_work() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            start_era_with_new_workloads(1, 1000, 3000);
...
fn new_era_with_stake_limit_should_work() {
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            assert_ok!(Staking::guarantee(Origin::signed(2), vec![(11, 2000)]));
            ...
            assert_ok!(Staking::guarantee(Origin::signed(4), vec![(11, 3000)]));
            ...
            start_era_with_new_workloads(5, 1, 200000000);
