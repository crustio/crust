...
thread_local! {
    ...
    static LEGAL_PK: Vec<u8> = hex::decode("19d322cb820e32257e21a18db7c16b71df09fd80ae7fd8b80cf974c891965dcbce54b5249ef0724ebb4abf5669ad357f7e32283e3413a5d28bb5080be926ce6c").unwrap();
    static LEGAL_CODE: Vec<u8> = hex::decode("6efae86dafe0618503d25ce1c8c2f919efb3b525a5b4e543f0a0ea2195a09857").unwrap();
}
...
pub struct RegisterInfo {
    ...
    pub ab_upgrade_pk: SworkerPubKey,
...
pub fn legal_register_info() -> RegisterInfo {
    ...
    let sig = hex::decode("84a23dde609fbcc33e2c9ed1eb8061ae436443a9d2ecf58817099e911aebac110d7f390ea9ab31e2fb23cc372168d74cd8063571d84f27a9db44e748683d7a68").unwrap();
    let prev_pk = hex::decode("ee704e9bcb2d306cfa0e751f2e7ba69fff3d2aa23594ae927636b20ca9d4f015a6be7b1f58219c556336df7880b639eaf072b2206c1a5058e03df88b558b4b3b").unwrap();

    RegisterInfo {
        ias_sig: ias_sig.to_vec(),
        ias_cert: ias_cert.to_vec(),
        account_id: applier,
        ab_upgrade_pk: prev_pk,
