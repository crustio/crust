    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            assert_ok!(Swork::report_works(
                ...
                legal_wr_info.reported_srd_size,
                legal_wr_info.reported_files_size,
        ...
        .execute_with(|| {
            ...
            assert_ok!(
                Swork::report_works(
                    ...
                    legal_wr_info_with_added_and_deleted_files.reported_srd_size,
                    legal_wr_info_with_added_and_deleted_files.reported_files_size,
        ...
        .execute_with(|| {
            ...
            assert_noop!(
                Swork::report_works(
                    ...
                    illegal_wr_info.reported_srd_size,
                    illegal_wr_info.reported_files_size,
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            assert_ok!(Swork::report_works(
                ...
                a_wr_info.reported_srd_size,
                a_wr_info.reported_files_size,
            ...
            assert_ok!(Swork::report_works(
                ...
                b_wr_info_1.reported_srd_size,
                b_wr_info_1.reported_files_size,
            ...
            assert_ok!(Swork::report_works(
                ...
                b_wr_info_2.reported_srd_size,
                b_wr_info_2.reported_files_size,
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            assert_ok!(Swork::report_works(
                ...
                wr_info_300.reported_srd_size,
                wr_info_300.reported_files_size,
            ...
            assert_noop!(
                Swork::report_works(
                    ...
                    wr_info_600.reported_srd_size,
                    wr_info_600.reported_files_size,
        ...
        .execute_with(|| {
            ...
            assert_noop!(
                Swork::report_works(
                    ...
                    b_wr_info.reported_srd_size,
                    b_wr_info.reported_files_size,
    ...
    ExtBuilder::default()
        ...
        .execute_with(|| {
            ...
            DispatchError::Module {
                index: 2,
                error: 11,
                message: Some("IllegalStoragePower"),
            });
...
#[test]
fn join_group_should_work_for_storage_power_in_work_report() {
    ExtBuilder::default()
        .build()
        .execute_with(|| {
            let alice = Sr25519Keyring::Alice.to_account_id();
            ...
            assert_ok!(Swork::report_works(
                ...
                alice_wr_info.reported_srd_size,
                alice_wr_info.reported_files_size,
            ...
            assert_ok!(Swork::report_works(
                ...
                bob_wr_info.reported_srd_size,
                bob_wr_info.reported_files_size,
            ...
            assert_ok!(Swork::report_works(
                ...
                eve_wr_info.reported_srd_size,
                eve_wr_info.reported_files_size,
