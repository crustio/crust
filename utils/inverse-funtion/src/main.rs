// x in [1, 330] to reprensent 0.1% -> 33%
...
fn add_head_comment() {
    ...
    println!("/// Under the utils/inverse-funtion folder,");
    println!("/// Run `cargo run > ../../cstrml/staking/src/inverse.rs`");
}
...
fn generate_function() {
    println!("pub fn inverse_function(x: Permill) -> (u32, Perbill) {{");
    println!("    match x.deconstruct() {{");
